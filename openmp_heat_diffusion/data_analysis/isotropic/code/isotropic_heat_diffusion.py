...
matrix_size = 1024
matrices = []
filepath = "output_matrix_1024.txt"
...
heatmap = ax.imshow(matrices[0], cmap='hot', interpolation='nearest', vmin=25, vmax=300,aspect='auto')
#print the colormap
...
ani = animation.FuncAnimation(
    fig, update, frames=matrices.shape[0], interval=150, blit=True
)

plt.show()

#Functions to save the animation
ani.save('heat_a_map.mp4', writer='ffmpeg')
ani.save('heat_a_map.gif', writer='pillow')
